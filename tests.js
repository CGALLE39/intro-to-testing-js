...
describe('sayHello' , function() {
    ...
    it('should return a greeting with the entered name', function () {
        expect(typeof sayHello()).toBe("string");
    });
    it('should return "Hello, " when executed', function() {
        expect(sayHello()).toBe("Hello, ");
    });
    it('should return "Hello, Jasmine" when passed Jasmine', function() {
        expect(sayHello).toBe("Hello, Jasmine");
    });
})
